...
function UserIcon() { return <svg aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="h-4 w-4"><circle cx="12" cy="8" r="4"/><path strokeLinecap="round" strokeLinejoin="round" d="M4 21a8 8 0 0 1 16 0"/></svg>; }
  ...
  return <header className="sticky top-0 z-50 border-b border-zinc-800 bg-zinc-950/95 backdrop-blur">
    <div className="mx-auto flex max-w-7xl items-center justify-between gap-2 px-3 py-3 sm:gap-3 sm:px-5">
      ...
      <div className="ml-auto flex items-center gap-1.5 sm:gap-2">
        ...
        {authenticated && <Link href="/cliente/minha-conta" aria-label="Minha conta" className="flex items-center gap-1.5 rounded-lg border border-blue-500/40 bg-blue-500/10 px-2.5 py-1.5 text-xs font-black text-blue-300 hover:bg-blue-500/20"><UserIcon/><span className="hidden sm:inline">Minha conta</span></Link>}
        ...
        {authenticated && <form action="/api/customer/logout" method="post" className="hidden xl:block"><button className="rounded-lg border border-red-500/30 px-2.5 py-1.5 text-xs font-bold text-red-300 hover:bg-red-500/10">Sair</button></form>}
