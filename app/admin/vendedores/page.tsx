...
export default async function SellersPage() {
  ...
  return <main className="mx-auto max-w-7xl px-4 py-10 sm:px-6 sm:py-12">
    <div className="flex flex-wrap items-end justify-between gap-5"><div><p className="text-sm font-black uppercase tracking-widest text-blue-400">Vitória Informática</p><h1 className="mt-2 text-3xl font-black sm:text-4xl">Vendedores</h1><p className="mt-3 text-zinc-400">Links individuais, vendas e comissão.</p></div><div className="flex flex-wrap gap-2 text-sm"><Link href="/admin/comissoes" className="rounded-lg border border-amber-500/40 px-3 py-2 font-bold text-amber-300 hover:bg-amber-500/10">Comissões</Link><Link href="/admin/pedidos" className="rounded-lg bg-blue-600 px-3 py-2 font-bold">Pedidos</Link><Link href="/admin" className="rounded-lg border border-zinc-700 px-3 py-2 font-bold">← Painel</Link></div></div>
