    ...
    <main className="mx-auto max-w-7xl px-6 py-12 md:py-16">
      ...
      <section className="py-14">
        <div className="mb-8 flex flex-wrap items-end justify-between gap-4">
          <div><p className="text-sm font-black uppercase tracking-widest text-red-400">Promoções</p><h2 className="mt-2 text-3xl font-black">Ofertas ativas</h2></div>
        ...
        {promotions.length ? (
          ...
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900 p-8 text-center"><p className="text-lg font-bold">Nenhuma promoção ativa no momento.</p><p className="mt-2 text-sm text-zinc-400">Assim que um produto for marcado como promoção, ele aparecerá automaticamente aqui.</p></div>
        )}
      </section>

      <section className="border-t border-zinc-800 py-14">
        <div className="mb-8"><p className="text-sm font-black uppercase tracking-widest text-blue-400">Destaques</p><h2 className="mt-2 text-3xl font-black">Produtos recomendados</h2></div>
        {highlights.length ? (
          ...
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900 p-8 text-center text-zinc-400">Nenhum produto em destaque no momento.</div>
        )}
      </section>
    </main>
  );
