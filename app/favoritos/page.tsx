  ...
  return (
    <main className="mx-auto max-w-7xl px-6 py-10 md:py-16">
      <div className="flex flex-wrap items-end justify-between gap-4">
        ...
        {favorites.length > 0 && (
          <button type="button" onClick={clearFavorites} className="rounded-xl border border-zinc-700 px-4 py-3 text-sm font-bold hover:bg-zinc-900">Limpar favoritos</button>
        )}
      </div>
