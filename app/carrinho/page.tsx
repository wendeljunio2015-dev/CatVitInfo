  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-12">
      ...
      <aside className="mt-8 rounded-2xl border border-zinc-800 bg-zinc-900 p-6">
        ...
        <p className="mt-4 text-sm leading-6 text-zinc-400">Ao informar nome e WhatsApp, seus dados serão vinculados ao orçamento para facilitar futuros atendimentos. O valor final, disponibilidade e garantia serão confirmados pela Vitória Informática.</p>
